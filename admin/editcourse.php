...
<div class="col-sm-6 mt-5  mx-3 jumbotron1">
    <h3 class="text-center"><b>Update Course Details</b></h3>
    <?php
 ...
 ?>
    <form action="" method="POST" enctype="multipart/form-data">
        <?php if(isset($msg)) {echo $msg;?> <script>
        setTimeout(() => {
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control shadow-none" id="course_id" name="course_id"
        ...
        <div class="form-group">
            ...
            <textarea class="form-control shadow-none" id="course_desc" name="course_desc"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control shadow-none" id="course_original_price" name="course_original_price"
                onkeypress="isInputNumber(event)"
                value="<?php if(isset($row['course_original_price'])) {echo $row['course_original_price']; }?>">
        </div>
        <div class="form-group">
            <label for="course_price">Course Selling Price</label>
            <input type="text" class="form-control shadow-none" id="course_price" name="course_price"
                onkeypress="isInputNumber(event)"
        ...
        <div class="text-center">
            <button type="submit" class="btn text-white searchbtnsr shadow-none" id="requpdate"
